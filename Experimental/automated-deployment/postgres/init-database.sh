...
psql -v ON_ERROR_STOP=1 --username "$POSTGRES_USER" --dbname "$POSTGRES_DB" <<-EOSQL
    CREATE USER keycloak WITH ENCRYPTED PASSWORD 'IBwpAHLBfG86l1RKQeJ5xQlFNacWPPbK';
    ...
    CREATE USER drive WITH ENCRYPTED PASSWORD 'TisMt7CmEkZAH9AmnVuWoiSKsQXqT1TP';
